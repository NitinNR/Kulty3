...
export const AdminVenuesPage = () => {
  ...
  const [owners, setOwners] = useState([]); // venue_owner users
  ...
  const openEdit = (venue) => {
    setForm({
      ...
      city: venue.city || '',
      cashbackPercentage: venue.cashbackPercentage || 0,
      status: venue.status || 'active',
      ownerId: venue.ownerId?._id || venue.ownerId || '',
    });
    setEditId(venue._id);
    setModal('edit');
  };
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="text-left px-6 py-3 text-gray-500 font-medium">Cashback</th>
              ...
              <tbody className="divide-y divide-gray-50">
                {venues.map((venue) => (
                  <tr key={venue._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-gray-700">{venue.cashbackPercentage}%</td>
                    <td className="px-6 py-4">
            ...
            {venues.length === 0 && (
              <div className="text-center py-12 text-gray-400">No venues yet. Add one!</div>
            )}
          </div>
        )}
      </div>
